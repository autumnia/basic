package com.autumnia.mytest.notification.controllers;

import com.autumnia.mytest.notification.services.IAlertService;
import com.autumnia.mytest.utils.CSlack;
import com.autumnia.mytest.utils.CTime;
...
public class NotiController {
    ...
    public String sendMessage(@PathVariable String message) {
        ...
        slack.send("lm-bot", env.getProperty("slack.api.hookurl"), slack.toString());
